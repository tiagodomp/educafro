...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $gruposDeDiscente->grupos_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $gruposDeDiscente->grupos_id)]
            )
        ?></li>
...
<div class="gruposDeDiscentes form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Grupos De Discente') ?></legend>
        <?php
        ?>
    </fieldset>
