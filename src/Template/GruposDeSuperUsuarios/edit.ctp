...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $gruposDeSuperUsuario->grupos_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $gruposDeSuperUsuario->grupos_id)]
            )
        ?></li>
...
<div class="gruposDeSuperUsuarios form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Grupos De Super Usuario') ?></legend>
        <?php
        ?>
    </fieldset>
