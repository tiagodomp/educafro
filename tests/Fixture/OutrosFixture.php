 ...
 *
 */
class OutrosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_outros_user1_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_outros_regras1_idx' => ['type' => 'index', 'columns' => ['regras_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id', 'user_id', 'regras_id'], 'length' => []],
            'id_UNIQUE' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
            'fk_outros_regras1' => ['type' => 'foreign', 'columns' => ['regras_id'], 'references' => ['regras', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_outros_user1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['user', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
